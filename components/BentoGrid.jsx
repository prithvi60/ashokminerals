...
const BentoGrid = () => {
  return (
    <section className="flex flex-col items-center w-full h-full grid-cols-1 gap-2.5 px-6 py-10 md:grid font-RobotoSlab md:grid-cols-3 sm:px-10 lg:px-16 xl:px-64 sm:py-12 lg:gap-6">
      ...
      <h2 className="tracking-widest !leading-snug flex items-center justify-center order-4 w-full h-full p-4 text-lg font-light rounded-md lg:col-span-1 md:p-6 sm:text-xl lg:text-2xl text-primary md:order-none bg-[linear-gradient(180deg,_#575757,_#FFFFFF_120%)]">
        Pioneering Calcium Carbonate Mining
      </h2>

      <h2 className="tracking-widest !leading-snug flex items-center justify-center order-2 w-full h-full col-span-2 p-4 text-lg font-light rounded-md lg:row-span-2 md:p-6 sm:text-xl lg:text-2xl text-primary md:order-none bg-[linear-gradient(180deg,_#BF0000,_#FFFFFF_130%)]">
