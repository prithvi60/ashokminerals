...
const Home = () => {
  return (
    <section className="w-full h-full font-RobotoSlab">
      ...
      <div className="w-full px-6 py-10 sm:py-14 sm:px-10 lg:px-16 font-RobotoSlab space-y-12">
        <div className="bg-black/20 p-4 md:p-6 space-y-6">
          <h4 className="w-full text-2xl tracking-wide font-semibold sm:text-3xl capitalize">
            Leadership
          </h4>
